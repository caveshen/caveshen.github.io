// PRD d17 (was §27) — the Badger owns `/`, no selection mechanism. The route
// is the selector, so these tests assert the Badger directly rather than via
// a toggle. Kept as `badger.spec.js`: the subject is still the Badger, ruled
// 2026-08-01 (d22's naming convention: name a test after its subject).
